        ...
        return Row(
          ...
          children: [
            IconButton(
              ...
              onPressed: viewModel.paginaAtual > 1
                  ? () => viewModel.carregarPagina(viewModel.paginaAtual - 1)
                  : null,
            ),
            ...List.generate(viewModel.totalPaginas, (index) {
              return TextButton(
                ...
                child: Text(
                  '${index + 1}',
                  style: TextStyle(
                    fontWeight: viewModel.paginaAtual == index + 1
                        ? FontWeight.bold
                        : FontWeight.normal,
                  ),
                ),
            ...
            IconButton(
              ...
              onPressed: viewModel.paginaAtual < viewModel.totalPaginas
                  ? () => viewModel.carregarPagina(viewModel.paginaAtual + 1)
                  : null,
            ),
          ],
